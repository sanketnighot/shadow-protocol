...
export function ConditionNode({ data }: NodeProps) {
  ...
  return (
    <div className="min-w-[220px] rounded-sm border border-blue-400/20 bg-background/95 p-4 shadow-none border border-white/5">
      <Handle type="target" position={Position.Left} className="bg-blue-400!" />
      <Handle type="source" position={Position.Right} className="bg-blue-400!" />
      <div className="flex items-center gap-3">
        <div className="rounded-sm border border-blue-400/20 bg-blue-400/10 p-2 text-blue-300">
