...
export function AppShell() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background px-3 py-3 text-foreground sm:px-5 sm:py-5 lg:px-8 lg:py-8">
      ...
      <div className="relative mx-auto flex max-w-[1600px] min-w-0 flex-col gap-4 sm:gap-5">
        <TitleBar />
